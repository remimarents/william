...
def build_pdf():
    ...
    story += [
        ...
        Paragraph("Treningsappen kan sende iMessage-påminnelser. Den kan sende dagens økt med lenke på et fast tidspunkt, og en egen påminnelse senere hvis dagens økt fortsatt mangler. Konto og innlogging håndteres felles via Marents-spillsiden, mens treningsdata lagres per bruker.", style["Lead"]),
        Table(
            [[
